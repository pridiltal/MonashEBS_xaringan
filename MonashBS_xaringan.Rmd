...
- Use `<span style="color:blue">text</span>` to change the colour.
- Use `<br>` to put a line break.

<highlight-block>
xaringan is so powerful! <br>  <span style="color:red">xaringan is so powerful!</span>
</highlight-block>
...
### Leaving 4 spaces does another magic
...
# <span style="color:#cc5900"> **Figures**  </span>  Using R
